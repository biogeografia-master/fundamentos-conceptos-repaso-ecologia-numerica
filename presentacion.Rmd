---
title: "Biogeografía"
subtitle: "Unidad 1. Fundamentos, contexto de la biogeografía y repaso de ecología numérica"
...
.footer[**Otros usos:** servicios ecosistémicos, invasoras, restauración.]
...
.footer[Recambio = diversidad beta → formaliza lo que Weber describió empíricamente.]
...
.small[
🏝 **Isla A**
Especies: `["Tigre", "Elefante", "Mono", "Cacatúa"]`
...
.footer[Ejemplo simple del recambio que Weber intuía en Wallacea.]
...
**Datos**: GBIF, IUCN, WorldClim, CHELSA Climate, NASA Earth Observations; repositorios nacionales (SiB Colombia, CONABIO, ALA).
...
# ✨ Y todo comenzó ... .yellow[**con la distancia**] 

---

<img src="img/eda-01.gif">
...
.pull-left[
<img src="img/eda-02.jpg">
]


.pull-right[
<img src="img/eda-03.jpg">
]

.small[Fuente: https://www.geckoboard.com/blog/anscombes-quartet-why-summary-metrics-lie/]

---

class: center, middle

<img src="img/eda-04.jpg">
...
```{r, eval=F}
# Estructura
head(x); tail(x); dim(x); str(x); names(x)

# Estadísticos descriptivos
summary(x); range(x); mean(x); median(x); sd(x)

# Aplicadas
apply(X, MARGIN = 1, FUN = mean)
tapply(x, INDEX = grupo, FUN = median)
aggregate(valor ~ grupo, data = df, FUN = sum)
```
]
...
.center[
<img src="img/agrupamiento-01.jpg" width="95%">
.small[<br>Borcard et al. (2018)]
]
...
.center[
<img src="img/agrupamiento-02.jpg">
.small[Borcard et al. (2018)]
]
...
.center[
<img src="img/ordenacion-no-restringida-02.jpg">
.small[Borcard et al. (2018)]
]
...
.center[
<img src="img/ordenacion-no-restringida-03.jpg">
.small[Borcard et al. (2018)]
]
...
.center[
<img src="img/ordenacion-no-restringida-04.jpg">
.small[Borcard et al. (2018)]
]
...
.center[
<img src="img/ordenacion-restringida-01.jpg" width="50%">
.small[<br>Borcard et al. (2018)]
]
...
.center[
<img src="img/ordenacion-restringida-02.jpg" width="50%">
.small[<br>Borcard et al. (2018)]
]
...
.small[<br>Fuente: https://github.com/biogeografia-master/scripts-de-analisis-BCI/blob/master/di_1_analisis_de_diversidad_diversidad_alpha.md]
]
